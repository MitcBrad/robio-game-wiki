            ...
            <div class="gamePage">
                <div class="create">
                    ...
                    <div class="createForm">
                        ...
                        <form action="other_conf.php" method="post" class="createInputs">
                            <input type="text" id="name" name="name" class="virusInputs" placeholder="Item Name">
                            ...
                            <button type="submit" class="addVirus">ADD ITEM</button>
                        </form>
